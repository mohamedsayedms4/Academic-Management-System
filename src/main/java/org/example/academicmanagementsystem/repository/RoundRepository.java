...
public interface RoundRepository extends JpaRepository<Round, Long> {
    ...
    @Query("SELECT r FROM Round r JOIN r.roundDiplomas rd WHERE rd.diploma.name = :diplomaName")
    List<Round> findByDiplomaName(@Param("diplomaName") String diplomaName);
